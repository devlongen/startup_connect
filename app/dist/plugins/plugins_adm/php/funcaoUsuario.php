                                    ...
                                    .'<div class="row">'
                                        .'<div class="col-8">'
                                            .'<div class="form-group">'
                                                ...
                                                .'<input type="text" value="'.$coluna["nome_usuario"].'" class="form-control" id="iNome" name="nome_alterar" maxlength="50">'
                                            .'</div>'
                                        .'</div>'
                                        .'<div class="col-4">'
                                            .'<div class="form-group">'
                                                .'<label for="iCpf">CPF:</label>'
                                                .'<input type="text" value="'.$coluna["cpf_usuario"].'" class="form-control" id="iCpf" name="cpf_alterar" maxlength="14">'
                                            .'</div>'
                                        .'</div>'
                                        .'<div class="col-6">'
                                            .'<div class="form-group">'
                                                .'<label for="iTelefone">Telefone:</label>'
                                                .'<input type="text" value="'.$coluna["telefone_usuario"].'" class="form-control" id="iTelefone" name="telefone_alterar" maxlength="15">'
                                            .'</div>'
                                        .'</div>'
                                        .'<div class="col-6">'
                                            .'<div class="form-group">'
                                                .'<label for="iDataNascimento">Data de Nascimento:</label>'
                                                .'<input type="date" value="'.$coluna["data_nascimento_usuario"].'" class="form-control" id="iDataNascimento" name="data_nascimento_alterar">'
                                            .'</div>'
                                        .'</div>'
                                        .'<div class="col-12">'
                                            .'<div class="form-group">'
                                                .'<label for="iEmail">Email:</label>'
                                                .'<input type="email" value="'.$coluna["email_usuario"].'" class="form-control" id="iEmail" name="email_alterar" maxlength="50">'
                                            .'</div>'
                                        .'</div>'
                                        .'<div class="col-12">'
                                            .'<div class="form-group">'
                                                .'<input type="checkbox" id="iAtivo" name="nAtivo_alterar">'
