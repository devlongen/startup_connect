                                ...
                                .'<div class="row">'
                                    .'<div class="col-12">'
                                        .'<div class="form-group">'
                                            ...
                                            .'<input type="text" value="'.$coluna["razao_social"].'" class="form-control" id="iDescricao" name="nDescricao" maxlength="80">'
                                        .'</div>'
                                    .'</div>'
                                .'</div>'
                    ...
                    .'<div class="modal-content">'
                        ...
                        .'<div class="modal-body">'
                            .'<form method="POST" action="php/salvarProduto.php?funcao=D&codigo='.$coluna["idprojeto"].'" enctype="multipart/form-data">'              
                                .'<div class="row">'
                                    .'<div class="col-12">'
                                        .'<h5>Deseja EXCLUIR o produto '.$coluna["razao_social"].'?</h5>'
                                    .'</div>'
                                .'</div>'
                                .'<div class="modal-footer">'
