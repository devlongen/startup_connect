...
<body>
    <div class="container" id="container">
        <div class="form-container sign-up">
            <form action="tela_login/backend/function/function_telas_login/function_tela_login_cadastro.php" method="post" name="cadastro_db">
        ...
        <div class="form-container sign-in">
            <form action="../tela_login/backend/function/function_telas_login/function_tela_login_cadastro.php" method="post" name="login_db">
                <h1>Entrar</h1>
